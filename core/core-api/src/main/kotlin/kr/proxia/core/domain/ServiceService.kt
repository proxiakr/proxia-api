...
class ServiceService(
    ...
    fun createAppService(
        ...
        val gitConnection = gitConnectionRepository.findByIdAndWorkspace(createAppService.gitConnectionId, workspace)
        ...
        val hasAccess = githubRepositoryClient.verifyRepositoryAccess(
            tokenResponse.token,
